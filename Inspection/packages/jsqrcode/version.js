...
Version = function(versionNumber, alignmentPatternCenters, ecBlocks1, ecBlocks2, ecBlocks3, ecBlocks4)
{
    ...
    this.buildFunctionPattern = function()
    {
        ...
        // Top right finder pattern + separator + format         bitMatrix.setRegion(dimension - 8, 0, 8, 9);
...
Version.decodeVersionInformation = function(versionBits)
{
    ...
    // We can tolerateup to 3 bits of error since no two version info codewords will     // differ in less than 4 bits.
    if (bestDifference <= 3)
    {
